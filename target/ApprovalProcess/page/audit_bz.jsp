...
<script type="text/javascript">
	...
	$(function(){
		$.post("${pageContext.request.contextPath}/bill/getBillByTaskId.action",{taskId:'${param.taskId}'},function(result){
			var bill=result.bill;
			$("#billPerson").val(bill.user.firstName+bill.user.lastName);
			$("#billDate").val(bill.billDate);
			$("#billMoney").val(bill.billMoney);
	...
	<form id="fm" method="post">
		<table cellspacing="8px">
			<tr>
				<td>申请人：</td>
				<td>
					<input type="text" id="billPerson" name="billPerson" readonly="readonly"/>
				</td>
				<td>&nbsp;</td>
				<td>申请日期：</td>
				<td>
					<input type="text" id="billDate" name="billDate" readonly="readonly"/>
				</td>
			</tr>
			<tr>
				<td valign="top">账单金额：</td>
				<td>
					<input type="text" id="billMoney" name="billMoney" readonly="readonly"/>
				</td>
			</tr>
			<tr>
				<td valign="top">账单用处：</td>
				<td colspan="4">
					<textarea id="billDetail" name="billDetail" rows="2" cols="49" readonly="readonly"></textarea>
				</td>
			</tr>
			<tr>
				<td valign="top">批注：</td>
