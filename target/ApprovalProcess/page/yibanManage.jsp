...
<head>
    ...
    <script type="text/javascript">
        ...
        function formatAction(val,row){
            return "<a href='javascript:openListActionDialog("+row.taskId+")'>流程执行过程</a>&nbsp;<a href='javascript:openListCommentDialog("+row.taskId+")'>历史批注</a>"
        }
...
<table id="dg" title="已办任务管理" class="easyui-datagrid"
       ...
       url="${pageContext.request.contextPath}/task/CompletedList.action?userName=${currentMemberShip.userName}" fit="true" toolbar="#tb">
    <thead>
    <tr>
...
<div id="tb">
    <div>
        ...
        <a href="${pageContext.request.contextPath}/export/taskExcel.action?userName=${currentMemberShip.userName}&name=已办任务表&status=2" class="tooltip-right">导出</a>
    </div>
</div>
